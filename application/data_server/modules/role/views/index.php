          ...
          <div class="form-group">
            <div class="row">
              <div style="padding-top:10px;" class="col-md-4 text-left">
                ...
                <b>Level Otorisasi : </b><i><?php echo $iddjabatan[0]->level_otorisasi; ?></i> <br>
                <b>Level User : </b><i><?php echo $iddjabatan[0]->level_user; ?></i>
              </div>
              <div style="padding-top:10px;" class="col-md-8 text-right">
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <button class="btn btn-primary btn-labeled btn-xs mr-2" id="sendalldata"><b><i class="icon-files-empty2"></i></b> Simpan</button>
                    <a class="btn btn-secondary btn-labeled btn-xs"  href="../../preference/user_administration/user_level/otorisasi"><b><i class="icon-arrow-left13"></i></b> Kembali</a>
                  </div>
                </div>
              </div>
            </div>
