...
class M_mop extends CI_Model
{
    ...
    var $kolom_order_mop = [null, 'm.no_reff_mop',  'm.nama_mop', 'c.cob', 'l.lob', 'a.nama_asuransi'];
    var $kolom_cari_mop  = ['LOWER(m.no_reff_mop)', 'LOWER(m.no_mop)', 'LOWER(m.nama_mop)', 'LOWER(c.cob)', 'LOWER(l.lob)', 'LOWER(a.nama_asuransi)'];
    ...
    public function _get_datatables_query_mop()
    {
        ...
        $this->db->select('m.*, c.cob, l.lob, a.nama_asuransi');
    ...
    {
        $this->db->select('m.*, c.cob, l.lob, a.nama_asuransi, n.nama_nasabah, ne.negara, pr.provinsi, k.kota, ke.kecamatan, d.desa');
        $this->db->from('mop as m');
        $this->db->join('m_cob as c', 'id_cob', 'inner');
        $this->db->join('m_lob as l', 'id_lob', 'inner');
