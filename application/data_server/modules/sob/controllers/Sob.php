  ...
  public function tampil_data_sob($action)
  {
    ...
    foreach ($list as $o) {
      ...
      if ($permisi[0] == 'true' || $action == '_') {
        $b1 = "<span style='cursor:pointer' class='mr-2 text-primary edit-sob ttip' data-toggle='tooltip' data-placement='top' title='Ubah' data-id='".$o['id_sob']."' nama='".$o['sob']."' desc='".$o['description']."' kode_sob='".$o['kode_sob']."'>
