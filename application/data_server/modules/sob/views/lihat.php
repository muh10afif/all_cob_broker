        ...
        <form id="form_sob" autocomplete="off">
          ...
          <div class="card-body d-flex justify-content-center">
            <div class="col-md-12">
              <div class="form-group">
                <label for="nama_sob" class=" col-form-label text-left">Kode SOB</label>
                <div class="">
                  <input type="text" class="form-control" name="kode_sob" id="kode_sob" value="<?= $kode_sob ?>" readonly>
                </div>
              </div>
              <div class="form-group">
                <label for="nama_sob" class=" col-form-label text-left">SOB<b style="color:red;">*</b></label>
                <div class="">
                  <input type="text" class="form-control" name="nama_sob" id="nama_sob" placeholder="Masukkan SOB">
                </div>
              </div>
              <div class="form-group">
                <label for="nama_sob" class=" col-form-label text-left">Description</label>
                <div class="">
          ...
          <div class="card-footer d-flex justify-content-end">
            <?php if ($role['create'] == true || $role == null): ?>
              <button type="button" class="btn btn-primary mt-1 mr-2" id="simpan_sob">Simpan</button>
            <?php endif; ?>
            <button type="button" class="btn btn-secondary mt-1 batal_sob" id="batal_sob">Batal</button>
          </div>
        </form>
      </div>
    </div>
