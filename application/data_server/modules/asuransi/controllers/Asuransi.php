...
class Asuransi extends CI_controller
{
  ...
  public function __construct() {
    parent::__construct();
    $this->load->model('tipe_as/M_tipe_as', 'tipe_as');
    $this->load->model('kategori_as/M_kategori_as', 'kategori_as');
  ...
  public function index($value='')
  {
    ...
    $data = [
      ...
      'tipe_as'       => $this->tipe_as->alltipeas(),
      'kategori_as'   => $this->kategori_as->allkategorias(),
