  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header bg-primary text-white">
            <h5 class="modal-title mt-0">Detail Business Partner</h5>
        ...
        <div class="modal-body">
            <div class="row p-3">
              <div class="col-md-6">
                  <div class="form-group row">
                      <label class="col-md-4 col-form-label text-left">Kode Business Partner</label>
  ...
  function detaild(id) {
    ...
    $.ajax({
      ...
      success  : function (data) {
        ...
        $("#t_kode").text(": "+hss[0].kode_business_partner);
