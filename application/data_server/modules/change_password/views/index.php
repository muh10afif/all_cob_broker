    ...
    <div class="card shadow">
      <div class="card-body">
        ...
        <div class="card-footer d-flex justify-content-end">
          <button type="submit" id="senddata" class="btn btn-primary waves-effect waves-light mr-2">Simpan</button>
          <button type="reset" id="cleardata" class="btn btn-secondary waves-effect">Batal</button>
        </div>
      </form>
    </div>
  </div>
