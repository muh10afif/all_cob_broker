...
class M_desa extends CI_Model {
    ...
    var $kolom_order_desa = ['m_kecamatan.kecamatan','m_desa.desa'];
    var $kolom_cari_desa  = ['LOWER(m_kecamatan.kecamatan)','LOWER(m_desa.desa)'];
    var $order_desa       = ['m_desa.id_desa' => 'desc'];
