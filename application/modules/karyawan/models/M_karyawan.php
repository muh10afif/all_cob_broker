...
class M_karyawan extends CI_Model
{
  ...
  var $kolom_order_user = [null,'m_karyawan.kode_karyawan','m_karyawan.nik','m_karyawan.nama_karyawan','m_bagian.bagian'];
  var $kolom_cari_user  = ['LOWER(m_karyawan.kode_karyawan)','LOWER(m_karyawan.nik)', 'LOWER(m_karyawan.nama_karyawan)', 'LOWER(m_bagian.bagian)', 'LOWER(m_jabatan.jabatan)'];
  var $order_user       = ['m_karyawan.id_karyawan' => 'desc'];
