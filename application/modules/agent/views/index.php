...
<?php if ($role['read'] == true || $role == null): ?>
  <div class="row">
    ...
    <div class="col-md-5">
      <div class="card shadow form_tambah">
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header bg-primary text-white">
            <h5 class="modal-title mt-0">Detail Agent</h5>
        ...
        <div class="modal-body">
            <div class="row p-3">
              <div class="col-md-6">
                  <div class="form-group row">
                      <label class="col-md-4 col-form-label text-left">Kode Agent</label>
                      <div class="col-md-8 mt-1">
                          <span id="t_kode_agent"</span>
                      </div>
                    </div>
                  <div class="form-group row">
  ...
  function detaild(id) {
    ...
    $.ajax({
      ...
      success  : function (data) {
        ...
        $("#t_kode_agent").text(": "+hss[0].kode_agent);
