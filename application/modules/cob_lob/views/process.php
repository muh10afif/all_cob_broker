<script type="text/javascript">
  ...
  function getkode() {
    $.ajax({
      type      :"GET",
      url       :"<?php echo base_url(); ?>cob_lob/cob_lob_kode",
      dataType  : "JSON",
      success   : function (data) {
        $('#cobkd').val(data.kode_cob);
        $('#lobkd').val(data.kode_lob);
      }
    });
  }
      ...
      if (nmlob == "" || tplob == "" || singkatan == "") {
        ...
        if (idlob == "") { //insert
          $.ajax({
            ...
            data: { nmlob:nmlob, tplob:tplob, kdlob:kdlob, singkatan:singkatan },
            dataType : "JSON",
            success  : function (data) {
              if (data['status'] == 'sukses') {
                swal({
                ...
                $('#singkatan').val('');
                $('.judul_lob').text('Tambah Data');
              } else if (data['status'] == 'gagal_singkatan') {
                swal({
                  title             : "Gagal",
                  text              : "Singkatan tersebut telah Ada",
                  type              : 'error',
                  showConfirmButton : false,
                  timer             : 3000
                });
