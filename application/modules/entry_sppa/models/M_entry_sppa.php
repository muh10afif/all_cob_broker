...
class M_entry_sppa extends CI_Model
{
  ...
  public function cari_lob($id_lob)
  {
    ...
    var $kolom_order_sppa = [null, 't.sppa_number', 's.sob', 'c.cob', 't.total_sum_insured', 't.total_akhir_premi', 't.total_tagihan'];
    var $kolom_cari_sppa  = ['LOWER(t.sppa_number)', 'LOWER(s.sob)', 'LOWER(c.cob)', 't.total_sum_insured', 't.total_akhir_premi', 't.total_tagihan'];
    ...
    public function _get_datatables_query_sppa()
    {
        ...
        $this->db->select('t.id_sppa_quotation as id, t.sppa_number, c.cob, l.lob, h.id_sob, s.sob, h.nama_sob, t.add_by, t.total_sum_insured, t.total_akhir_premi, t.total_tagihan');
