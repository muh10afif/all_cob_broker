...
<div class="row">
  ...
  <div class="col-md-5">
    <div class="card shadow">
        ...
        <?php endif;  ?>
      <div class="card-body">
        <table class="table table-bordered table-hover tabel_entry" style="border-collapse: collapse; border-spacing: 0; width: 100%; " id="tabel_entry" width="100%" cellspacing="0">
          <thead class="thead-light text-center">
            <tr>
              <th style="vertical-align: middle;" width="5%">No</th>
              <th style="vertical-align: middle;">No SPPA</th>
              <th style="vertical-align: middle;">Client [SOB - CDB]</th>
              <th style="vertical-align: middle;">COB - LOB</th>
              <th style="vertical-align: middle;">TSI</th>
