            ...
            <form id="form_mop" autocomplete="off">
                ...
                <div class="card-body row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="no_mop" class="col-md-3 col-form-label text-left">Nomor Dokumen <span class="text-danger">*</span></label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row sel2">
                            <label for="id_cob" class="col-md-3 col-form-label text-left">COB <span class="text-danger">*</span></label>
                            <div class="col-md-9">
                                <input type="hidden" id="id_cob_sel">
                                <select name="id_cob" id="id_cob" required data-parsley-required-message="COB is required." class="select2" style="height: 100%;">
                                    <option value="">Pilih COB</option>
                                    <?php foreach ($cob as $c): ?>
                                        <option value="<?= $c['id_cob'] ?>"><?= $c['cob'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>   
                        <div class="form-group row sel2">
                            <label for="id_lob" class="col-md-3 col-form-label text-left">LOB <span class="text-danger">*</span></label>
                            <div class="col-md-9">
                                <input type="hidden" id="id_lob_sel">
                                <select name="id_lob" id="id_lob" required data-parsley-required-message="LOB is required." class="select2" style="height: 100%;">
                                    <option value="">Pilih LOB</option>
                                
                                </select>
                            </div>
                        </div>   
                        <div class="form-group row t_coverage" style="display: none;">
                            <div class="col-md-12 table-responsive">
                                <button class="btn btn-primary" type="button" id="tambah_coverage">Tambah</button>
                        ...
                        <div class="form-group row">
                            <label for="nilai_pertanggungan" class="col-md-3 col-form-label text-left">Nilai Pertanggungan <span class="text-danger">*</span></label>
                            <div class="col-md-9">
                                <input type="text" required id="nilai_pertanggungan" name="nilai_pertanggungan" class="form-control ribuan1 numeric number_separator" placeholder="Masukkan Nilai Pertanggungan">
                            </div>
                        </div>  
                        <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <textarea name="penyampaian_deklarasi" class="tiny" id="penyampaian_deklarasi" cols="30" rows="10"></textarea>
                            </div>
                        </div>
