                            ...
                            <div class="col-md-4" <?= $hid_kn ?>>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="mb-0 judul_<?= $p['id_parent_parameter'] ?>">Tambah Data</h5>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <form id="form_parameter_scoring_<?= $p['id_parent_parameter'] ?>" class="form_parameter_scoring_<?= $p['id_parent_parameter'] ?>" autocomplete="off">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <p class="font-italic text-danger">('*') Menandakan Form Harus di Isi</p>
                                    ...
                                    <div class="card-footer d-flex justify-content-end">
                                        ...
                                        <?php if ($role['create'] == 'true' || $id_lvl_otorisasi == 0) : ?>
                                            <button type="button" class="btn btn-primary mt-1 mr-2 simpan_parameter_scoring" id_parent="<?= $p['id_parent_parameter'] ?>">Simpan</button>
                                        <?php endif; ?>
                                        <button type="button" class="btn btn-secondary mt-1 batal_parameter_scoring" id_parent="<?= $p['id_parent_parameter'] ?>">Batal</button>
                                    </div>
                                </div>
                            </div>
                            </div>
                    ...
                    if (result.value) {
                        $.ajax({
                            ...
                            success : function (data) {
                                ...
                                $('.judul_'+id_parent).text('Tambah Data');
                            }
                        })
        ...
        $('.tabel_master_parameter_scoring').on('click', '.edit-parameter_scoring', function () {
            ...
            $.ajax({
                ...
                success     : function (data) {
                    ...
                    $('.judul_'+data.list.id_parent_parameter).text('Ubah Data');
                },
