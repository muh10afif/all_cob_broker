...
<div class="card shadow">
  ...
  <?php if ($role['create'] == true || $role == null): ?>
    <div class="card-footer d-flex justify-content-end">
      <button class="btn btn-primary waves-effect waves-light mr-2" id="sendntro">Simpan</button>
      <button class="btn btn-secondary waves-effect" id="clearntro">Batal</button>
    </div>
  <?php endif; ?>
</div>
