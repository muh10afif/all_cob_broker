            ...
            <form id="form_parent_parameter" autocomplete="off">
                ...
                <div class="card-footer d-flex justify-content-end">
                    <?php if ($role['create'] == 'true' || $id_lvl_otorisasi == 0) : ?>
                        <button type="button" class="btn btn-primary mt-1 mr-2" id="simpan_parent_parameter">Simpan</button>
                    <?php endif; ?>

                    <button type="button" class="btn btn-secondary mt-1 batal_parent_parameter" id="batal_parent_parameter">Batal</button>
                </div>   
            </form>
        </div>
    </div>
