      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-8 col-lg-6 col-xl-5">
            <div class="card overflow-hidden shadow">
              <div class="bg-login text-center">
                ...
                <div class="position-relative">
                  <h2 class="text-white mt-0 mb-0"><img src="<?= base_url() ?>assets/img/legowo icon.png" alt="" height="125"></h2>
                </div>
              </div>
            ...
            <div class="mt-5 text-center"><p>Powered By SKDigital © 2021</p></div>
          </div>
        </div>
      </div>
    </div>
